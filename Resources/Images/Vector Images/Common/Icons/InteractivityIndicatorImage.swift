//
//  InteractivityIndicatorImage.swift
//  Slate
//
//  Created by John Coates on 6/20/17.
...
extension DrawProxyDSL {
    class InteractivityIndicatorImage: VectorImageAsset {
        
        let asset = CommonIcon.interactivityIndicator
